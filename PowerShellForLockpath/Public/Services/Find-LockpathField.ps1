function Find-LockpathField {
    ...
    Write-LockpathInvocationLog -Confirm:$false -WhatIf:$false -Confirm:$false -WhatIf:$falsefunction Get-LockpathFields {
        <#
    .SYNOPSIS
        Returns all field details for selected fields based on the applied filter.
    ...
    #>
        ...
        Write-LockpathInvocationLog -Confirm:$false -WhatIf:$false -Confirm:$false -WhatIf:$false
