function Read-LockpathCredential {
    ...
    if (-not [String]::IsNullOrEmpty($content)) {
        try {
            ...
            Write-LockpathInvocationLog -Message "Restoring login credentials from file.  These values can be cleared in the future by calling Clear-LockpathAuthentication." -Level Verbose
